...
# Data 
R [@R], a statistical programming language, is exclusively used in this paper. To clean and prepare the data, the libraries dplyr [@dplyr], knitr [@knitr] are used. For the graphs, ggplot2 [@ggplot] is used. 
